...
public class ReplyDAOImpl implements ReplyDAO {
	...
	public void updateIp(String ip, String replyer, String replytext) throws Exception {
		 ...
		 paramMap.put("replyer", replyer);
		 paramMap.put("replytext", replytext);
		
		session.update(namespace+".updateIp", paramMap);
	...
	public List<ReplyVO> read_reply(SearchCriteria cri) throws Exception {
		return session.selectList(namespace+".read_reply", cri);
	}

	@Override
	public int listReplyCount(SearchCriteria cri) throws Exception {
		return session.selectOne(namespace+".listReplyCount", cri);
	}
}