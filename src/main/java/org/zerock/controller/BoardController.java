...
public class BoardController {
	...
	public String modifyPost(BoardVO vo,RedirectAttributes ra) throws Exception {
		service.modify(vo);
	...
	public void listPage2(@ModelAttribute("cri")Criteria cri, Model model) throws Exception { //countPage 처리
	//public void listPage(Criteria cri, Model model) throws Exception {
		model.addAttribute("list", service.listCriteria(cri));
		PageMaker pageMaker = new PageMaker();
		pageMaker.setCri(cri);		 
		...
		pageMaker.setTotalCount(service.listCountCriteria(cri)); //sql 카운트 처리
		model.addAttribute("pageMaker", pageMaker);
	}
	...
	public String modifyPOST2(BoardVO board, Criteria cri, RedirectAttributes rttr) throws Exception {
