...
$(document).ready(function(){
	...
	$(".join_button").click(function(){
        ...
        /* 최종 유효성 검사 */
        if(idCheck&&idckCheck&&pwCheck&&pwckCheck&&pwckcorCheck&&nameCheck&&mailCheck&&mailnumCheck&&mobileCheck&&mobilenumCheck){
 			$("#join").attr("action", "/user/join");
			$("#join").submit();
        }if(!idCheck){
        	...
        	error[4].innerHTML = "필수 정보입니다. 인증이 필요합니다.";
