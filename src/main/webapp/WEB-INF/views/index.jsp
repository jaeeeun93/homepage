...
$(document).ready(function(){ 	
	window.onbeforeunload = function(e){
		...
		var values = {emp_id : $('#emp_id').val()};		
		var Complete = function(row){}.bind(this);
		
		Ajax('/elec_approval/receive/exit_browser', $.extend(values, {dataType : 'json', async : true}), Complete);
						...
						<!-- Section -->
							<section>
								...
								<div class="posts">
									...
									<article>
										<a href="/sboard/readPage${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${list.bno}" class="image"><img src="${list.src }" width="360.45" height="221.81" alt="" /></a>
					...
					<div class="inner">
						...
						<!-- Menu -->
							<nav id="menu">
								...
								<ul>
									...
									<li>
										<span class="opener">채식식당 찾기</span>
										<ul>
						...
						<!-- Section -->
							<section>
								...
								<ul class="contact">
									<iframe src="/chat.do" style="width:100%; height:500px"></iframe>
								</ul>
							</section>
