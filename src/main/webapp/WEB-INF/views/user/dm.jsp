				...
				<div class="col-12 col-lg-5 col-xl-3 border-right">
					...
					<a href="/user/dm?following=${list.to_id }" class="list-group-item list-group-item-action border-0">
						<div class="d-flex align-items-start">
							<img src="/imgUpload${other }" class="rounded-circle mr-1" alt="Vanessa Tucker" width="40" height="40">
					...
					<div class="py-2 px-4 border-bottom d-none d-lg-block">
						<div class="d-flex align-items-center py-1">
							<div class="position-relative">
								<img src="/imgUpload${other }" class="rounded-circle mr-1" alt="Sharon Lessman" width="40" height="40">
							</div>
							...
							<c:choose>
								...
								<c:when test="${list.to_id eq sessionScope.id }">
									<div class="chat-message-left pb-4">
										<div>
											<img src="/imgUpload${other }" class="rounded-circle mr-1" alt="Chris Wood" width="40" height="40">
								...
								<c:otherwise>
									<div class="chat-message-right pb-4">
										<div>
											<img src="/imgUpload${profile }" class="rounded-circle mr-1" alt="Chris Wood" width="40" height="40">
											<div class="text-muted small text-nowrap mt-2">${list.regdate }</div>
										</div>
										<div class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
											<div class="font-weight-bold mb-1">${list.from_id }</div>
